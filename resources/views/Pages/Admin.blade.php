...
<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <h2>Bienvenue monsieur/madame l'administrateur/trice <br> <strong>{{ Auth::user()->name }}</strong></h2>
...
<audio id="popupSound" src="{{ asset('sounds/hello.mp3') }}" preload="auto"></audio>
@endsection
