...
<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <h2>Bienvenue dans votre espace utilisateur <br> <strong>{{ Auth::user()->name }}</strong></h2>
        <img src="../images/icons/catttt.gif">
...
<audio id="popupSound" src="{{ asset('sounds/cute.mp3') }}" preload="auto"></audio>
@endsection
