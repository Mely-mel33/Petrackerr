...
<body>
    ...
    @section('content')
        <div class="container">
            <h1>Prendre un Rendez-vous pour ton animal</h1>
            @if (session('success'))
            ...
            <form action="{{ route('Prendrdv.store') }}" method="POST">
                ...
                @if (isset($pet))
                    <div class="form-group">
                        ...
                        <input type="text" id="animal_nom" name="animal_nom" value="{{ $pet->Nom }}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="Espèce">Espèce :</label>
                        <input type="text" id="animal_espece" name="animal_espece" value="{{ $pet->Espèce }}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="Age">Âge :</label>
                        <input type="text" id="animal_age" name="animal_age" value="{{ $pet->Age }} ans" readonly>
                    </div>
                @endif
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="veterinaire_nom" name="veterinaire_nom" required
                        placeholder="Nom du vétérinaire">
                </div>
                <div class="form-group">
                    <label for="veterinaire_localisation">Localisation du Cabinet :</label>
                    <input type="text" id="veterinaire_localisation" name="veterinaire_location" required
                        placeholder="Localisation du cabinet">
                </div>
